...
- **См. также:**
  - [Диаграмма жизненного цикла](./instance.md#Диаграмма-жизненного-цикла)
  - [Распределение содержимого слотами](./components.md#Распределение-содержимого-слотами)
...
- массивом строк, или
- объектом, где ключи стоят для местного связывания имени, а значение является:
...
- **Модификаторы:**
  ...
  - `.passive` - (2.3.0+) вызов обработчика события dom с параметром `{ passive: true }`.
...
- **См. также:** [Распределение содержимого слотами](./components.md#Распределение-содержимого-слотами)
