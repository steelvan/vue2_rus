...
Если вы хотите прямо сейчас поработать с однофайловыми компонентами — начните с этого [простого todo приложения](https://codesandbox.io/s/o29j95wx9) на CodeSandbox.
...
CLI позаботится о большинстве настроек конфигурации сборки для вас, но при необходимости позволяет настроить любые детали через [настройки конфигурации](https://cli.vuejs.org/ru/config/).
